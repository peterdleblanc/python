...
from util_updated import to_two_bytes, two_byte_iter_to_str, pin_list_to_board_dict, get_the_board
...
class Board(object):
    ...
    def setup_layout(self, board_layout):
        ...
        """
        print('setting up board layout')
        print('board def: %s', board_layout)
...
class Port(object):
    ...
    def write(self):
        ...
        #msg = [DIGITAL_MESSAGE + self.port_number, mask % 128, mask >> 7]
        print('writting message: ', msg)
        self.board.sp.write(msg)
        print('board write complete')
    ...
    def write(self, value):
        ...
        if value is not self.value:
            ...
            if self.mode is OUTPUT:
                ...
                self.board.sp.write(msg)
def main():
    board = Board('/dev/ttyACM0',layout=BOARDS['arduino'])
    board.auto_setup()
